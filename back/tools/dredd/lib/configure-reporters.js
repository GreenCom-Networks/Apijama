...
var ApiaryReporter, BaseReporter, ApijamaReporter, CliReporter, DotReporter, HtmlReporter, MarkdownReporter, NyanCatReporter, XUnitReporter, cliReporters, configureReporters, fileReporters, intersection, logger,
  indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

BaseReporter = require('./reporters/base-reporter');

ApijamaReporter = require('./reporters/apijama-reporter');
...
fileReporters = ['junit', 'html', 'markdown', 'apiary', 'apijama'];
...
configureReporters = function(config, stats, tests, runner) {
  ...
  addReporter = function(reporter, emitter, stats, tests, path) {
    var apijamaReporter, apiaryReporter, dotReporter, htmlReporter, mdReporter, nyanCatReporter, xUnitReporter;
    switch (reporter) {
      case 'junit':
      ...
      case 'apijama':
        return apijamaReporter = new ApijamaReporter(emitter, stats, tests, config, runner);
    }
  };
